if IY_LOADED and not _G.IY_DEBUG == true then
    -- error("Alina Yield is already running!", 0)
    return
end
...
PluginsHint.Text = "Download plugins from the IY Discord (discord.gg/zeHgkxzrAR)"
...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		if everyClipboard then
			toClipboard("https://discord.gg/zeHgkxzrAR")
		...
		inviteButton.Text = "Copy Discord Invite Link (https://discord.gg/zeHgkxzrAR)"
	end)
	dragGUI(main)
	main.Parent = PARENT
...
CMDs[#CMDs + 1] = {NAME = 'explorer / dex', DESC = 'Opens DEX by Alina'}
CMDs[#CMDs + 1] = {NAME = 'olddex / odex', DESC = 'Opens Old DEX by Alina'}
...
CMDs[#CMDs + 1] = {NAME = 'GFfly [true / false]', DESC = 'enables or disables the G and F hotkeys for fly'}
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if everyClipboard then
		toClipboard('https://discord.gg/zeHgkxzrAR')
		notify('Discord Invite', 'Copied to clipboard!\ndiscord.gg/zeHgkxzrAR')
	else
		notify('Discord Invite', 'discord.gg/zeHgkxzrAR')
	end
	if httprequest then
		httprequest({
